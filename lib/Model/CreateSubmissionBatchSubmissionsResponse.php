...
/**
 * CreateSubmissionBatchSubmissionsResponse Class Doc Comment
 *
 * @category Class
 * @package  FormAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CreateSubmissionBatchSubmissionsResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_submission_batch_submissions_response';
    ...
    const STATUS_VALID_BUT_NOT_SAVED = 'valid_but_not_saved';
    ...
    public function getStatusAllowableValues()
    {
        return [
            self::STATUS_SUCCESS,
            self::STATUS_ERROR,
            self::STATUS_VALID_BUT_NOT_SAVED,
        ];
    }
